...
function changeColor(element) {
    ...
    if(currentColor === "white" || currentColor === "skyblue"){
        element.style.color = "red";
    }
    if(document.body.style.backgroundImage === 'url("imagenes/argentina.jpg")'){
        element.style.color = "skyblue";
        element.style.filter = 'drop-shadow(0 0 0.75rem rgb(118, 226, 245))';
    }
    else{
        element.style.color = "red";
    }
...
function cambiarImagenFondo(){
    if(!bandera){
        document.body.style.backgroundImage = "url('imagenes/argentina.jpg')";
        document.querySelector(".inicioImagen1").style.backgroundImage = "url('imagenes/rana.png')";
        document.querySelector(".inicioImagen2").style.backgroundImage = "url('imagenes/avionArg.png')";
        document.querySelector(".inicioImagen3").style.backgroundImage = "url('imagenes/avionArg2.jpg')";
        document.querySelector(".inicioImagen4").style.backgroundImage = "url('imagenes/malvinas.png')";
        bandera = true;
    }else{
        document.body.style.backgroundImage = "url('imagenes/tanques.jpg')";
        document.querySelector(".inicioImagen1").style.backgroundImage = "url('imagenes/tanques.jpg')";
        document.querySelector(".inicioImagen2").style.backgroundImage = "url('imagenes/mira.jpg')";
        document.querySelector(".inicioImagen3").style.backgroundImage = "url('imagenes/stuff.jpg')";
        document.querySelector(".inicioImagen4").style.backgroundImage = "url('imagenes/chica.png')";
        bandera = false;
    }
...
>>>>>>> 6632f60892b9929791563c36008db2b89cc1f590
}